...
function selectData(){
	...
	$.ajax({
        url:'/springajax2/getPeopleJSON.do',
        type:'POST',
        ...
        success:function(data){
        	$.each(data, function(index, item){
       	     	...
       	     	output += '<td width="110"><a href="/springajax2/getPeopleJSON.do" class="updateform_data" ';
	     		output += 'id=' + item.id + '>수정</a> ';
       	    	output += '<a href="/springajax2/deletePeople.do" class="delete_data" ';
...
$(document).ready(function(){ 
 	...
 	$('#input_data').click(function(event){
	  	...
	  	jQuery.ajax({
	       	url : '/springajax2/insertPeople.do',
	       	type : 'POST',
	       	...
	       	success: function (data) {	
	       		$.each(data, function(index, item){
			     		...
			     		output += 'id=' + item.id + '>수정</a> ';
				       	...
				       	output += '<td width="110"><a href="/springajax2/updatePeople.do" class="update_data" ';
			       		output += 'id=' + item.id + '>수정</a> ';
